...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hot4.DataModel.Models.StockData", b =>
                {
                    b.Property<byte>("StockDataId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<byte>("StockDataId"));
            ...
            modelBuilder.Entity("Hot4.DataModel.Models.SelfTopUp", b =>
                {
                    ...
                    b.HasOne("Hot4.DataModel.Models.SelfTopUpState", "SelfTopUpState")
                        .WithMany("SelfTopUps")
                        .HasForeignKey("StateId")
                        .IsRequired()

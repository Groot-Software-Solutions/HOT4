...
namespace Hot4.DataModel.Migrations
{
    ...
    public partial class createtriggeraccess : Migration
    {
        ...
        {
            migrationBuilder.Sql(@"ALTER TRIGGER [dbo].[trgEnsurePasswordHash] ON  
            ...
            migrationBuilder.Sql(@"ALTER TRIGGER [dbo].[trgOnlyOneActiveAccess_OnInsert] 
               ON  [dbo].[tblAccess] 
               AFTER INSERT
            AS 
            BEGIN
            ...
            migrationBuilder.Sql(@"ALTER TRIGGER [dbo].[trgOnlyOneActiveAccess_OnUpdate] 
               ON  [dbo].[tblAccess] 
               AFTER UPDATE
            AS 
            BEGIN
            ...
            migrationBuilder.Sql(@"ALTER TRIGGER [dbo].[trgStopBlank] 
               ON  [dbo].[tblAccess] 
               AFTER INSERT,UPDATE
            AS 
            BEGIN

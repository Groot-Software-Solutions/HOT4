        ...
        Public Overrides Function RechargePrepaid(recharge As xRecharge, Optional numberOfDays As Integer = 90) As ServiceRechargeResponse
            ...
            Try
                ...
                If recharge.Amount >= 0 Then
                    'Execute Credit
                    Dim juiceResponse As JuiceRechargeUSDResponse = Nothing
                    Dim response As TopupResponse = Nothing
                    Try

                        Dim request = New JuiceRechargeUSDRequest() With
                        {
                        .Body = New JuiceRechargeUSDRequestBody() With {
                        ...
                        juiceResponse = telecel.JuiceRechargeUSD(request)
                        ' Throw New Exception("It failed.")
                        response = juiceResponse.Body.JuiceRechargeUSDResult

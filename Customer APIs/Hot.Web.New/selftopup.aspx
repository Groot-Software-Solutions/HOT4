<%@ Page Language="VB" MasterPageFile="~/main.master" AutoEventWireup="false" CodeFile="selftopup.aspx.vb" Inherits="selftopup" %>
...
<div class="page secondary ">
            ...
            <div class="page-region-content">
                <div class="span9" style="min-height:450px;" runat="server" id="txtContent">                	
					...
					<form runat="server" id="frmSelfTopup" class="span4 offset2" >
						...
						<h3 style="text-align:center;" >Recharge Amount</h3>
						<div class="input-control text"> 
							<input  runat="server" type="text" name="txtAmount" placeholder="Topup Amount" id="txtAmount" style="text-align:center;" onkeyup="javascript: number_amount(this);"/> 
							<button class="btn-clear" tabindex="-1" type="button"/>
						</div>  
						...
						<input  runat="server" type="submit" id="cmdSelfGo" value="Go Topup" class="Hot-btn place-right" style="margin-right:29%;" /> 
    ...
    <script>
        ...
        function checkform() {
            amount = $('#ctl00_ContentPlaceHolder1_txtAmount').val().replace(/[^0-9,.]/g, "");
